...
export const metadata: Metadata = {
  title: "Form templates — Simple Form",
  description:
    "Browse ten battle-tested form templates. Pick one, tweak it, ship it.",
};
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-body text-muted-foreground">
                Ten battle-tested form templates covering the most common use
                cases — feedback, registration, sales, intake, NPS, and more.
                Pick one, tweak it in the builder, ship it in minutes.
              </p>
            </div>
