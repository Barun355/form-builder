...
import { useFormAnalyticsTrend } from "~/hooks/analytics";
  ...
  return (
    <div className="rounded-2xl border bg-card p-5">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 className="text-h4 text-foreground">Submission trend</h3>
          <p className="text-body-sm text-muted-foreground mt-0.5 tabular-nums">
            {isLoading
              ? "Loading..."
              : `${total.toLocaleString()} submission${total === 1 ? "" : "s"} in the last ${range} days`}
          </p>
        </div>
      ...
      <div className="mt-5 h-64">
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <defs>
                <linearGradient id="trendFillForm" x1="0" y1="0" x2="0" y2="1">
                  <stop
                    offset="0%"
